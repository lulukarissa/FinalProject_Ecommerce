...
class Shop extends Component {
    ...
    alphabeticalasc = (e)=>{
        e.preventDefault();
        axios.get(`${API_URL}/alphabeticalasc`)
        .then((x)=>{
            this.setState({
                products: x.data
            })
    ...
    alphabeticaldesc = (e)=>{
        e.preventDefault();
        axios.get(`${API_URL}/alphabeticaldesc`)
        .then((x)=>{
            this.setState({
                products: x.data
            })
